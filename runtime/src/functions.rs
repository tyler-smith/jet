...
use crate::{ADDRESS_SIZE_BYTES, Context, FN_NAME_CONTRACT_PREFIX};
...
#[no_mangle]
#[export_name = "jet.contracts.lookup"]
...
#[no_mangle]
#[export_name = "jet.new.main_exec_ctx"]
...
#[no_mangle]
#[export_name = "jet.contracts.call_return_data_copy"]
