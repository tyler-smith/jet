...
pub struct Context {
    ...
    stack: [u8; (32 * STACK_SIZE_WORDS) as usize],

    memory: [u8; (32 * MEMORY_INITIAL_SIZE_WORDS) as usize],
    memory_len: u32,
    memory_cap: u32,
}
...
// //
// #[no_mangle]
// pub extern "C" fn jet_new_context() -> Context {
//     let init_memory_buf = [0u8; (WORD_SIZE_BYTES * MEMORY_INITIAL_SIZE_WORDS) as usize];
//     Context {
//         stack_ptr: 0,
//         jump_ptr: 0,
...
//
// #[no_mangle]
// pub extern "C" fn jet_new_contract_run(result: ReturnCode, ctx: Context) -> ContractRun {
//     ContractRun { result, ctx }
// }
